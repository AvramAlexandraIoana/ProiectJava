...
public class ExceptionHandling {
    ...
    public ResponseEntity<Object> transactionContentValidation(MethodArgumentNotValidException exception) {
    ...
    public ResponseEntity<Object> retriveTransactionValidation(ObjectNotFoundException exception) {
        Map<String, Object> body = new HashMap<>();
        body.put("timestamp", LocalDate.now());
